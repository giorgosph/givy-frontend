  ...
  useEffect(() => {
    if(!!filteredDraws && filteredDraws.length > 0) {
      ...
      switch (sortData) {
        case 'default':
        case 'openingDay':
          sortedDraws.sort((a, b) => new Date(a.openingDate).getTime() - new Date(b.openingDate).getTime());
          break;
        case 'closingDay':
          sortedDraws.sort((a, b) => new Date(a.closingDate).getTime() - new Date(b.closingDate).getTime());
          break;
        case 'raffleValue':
